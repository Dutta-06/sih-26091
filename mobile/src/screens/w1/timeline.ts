...
export function describeEvent(e: CaseEvent, i: number): TimelineItem {
  ...
  switch (e.type) {
    case "profile_started":
      return { ...base, title: "u1.tl.profile_started", tone: "azure", target: { tab: "assistant" } };
    ...
    case "analysis_run":
      return { ...base, title: "u1.tl.analysis_run", tone: "azure", target: home("report") };
    case "activity_chosen":
      return d.activityId
        ? { ...base, title: "u1.tl.activity_chosen", vars: { idea: `~act:${d.activityId}` }, tone: "azure", target: { tab: "plan" } }
        : { ...base, title: "u1.tl.analysis_run", tone: "azure", target: { tab: "plan" } };
    ...
    case "consent":
      return { ...base, title: d.granted === true ? "u1.tl.consentOn" : d.granted === false ? "u1.tl.consentOff" : "u1.tl.consent", tone: d.granted === false ? "clay" : "azure", target: home("privacy") };
    case "data_deleted":
    ...
    case "follow_up":
      return { ...base, title: "u1.tl.follow_up", tone: "azure", target: home("outcome") };
    case "grievance":
...
export function timelineItems(s: Pick<JourneyState, "events" | "chat">): TimelineItem[] {
  ...
  if (firstChat) items.push({ id: "chat", at: firstChat, kind: "chat", title: "u1.tl.chat", tone: "azure", target: { tab: "assistant" } });
